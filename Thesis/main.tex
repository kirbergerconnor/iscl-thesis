...
Overall, constructed languages do not appear as isolated from the natural languages in the feature distribution plots as was initially expected. Even when some level of distinction was more clear, for example with MATTR, it did not include all constructed languages. In particular, Esperanto often appeared to be much more comparable to many of the natural languages than its peers. With respect to lexical and morphological complexity, Espernato's 
