...
Precision, recall, and F1-score were calculated for all five models, given by Equations \ref{eq:precision}, \ref{eq:recall}, and \ref{f1score}, respectively. These are standard metrics which are commonly used in machine learning tasks, including for supervised classification and unsupervised anomaly detection. 
...
\begin{table}[!h]
  ...
  \end{tabular}
  \caption{Precision, Recall, and F1-scores of Supervised Binary Classifiers}
...
Additionally, I want to thank my friends and family who helped me at every step. Though I would not be able to name all of them here, I am especially grateful for the support from my good friends Fidan, Leixin, Pascal, and Lisa, as well as from my siblings, parents, grandparents, and aunt. 
