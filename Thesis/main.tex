...
In total, twenty-four languages are analyzed in this study. Six of these are constructed: Esperanto, Interlingua, Lingua Franca Nova, Volapük, Kotava, and Ido. 
...
\subsubsection{Constructed Languages}
\label{sec:constructedlanguages}

Six constructed languages are used in this study. 

% Esperanto, the most successful and widely spoken constructed language, was created by Polish-Jewish ophthalmologist L. L. Zamenhof in 1887. Zamenhof’s goal was to create a neutral, easy-to-learn second language that could foster international peace and understanding. Esperanto is a highly regular language, with consistent grammar and a simplified, phonetic spelling system. It draws vocabulary primarily from Romance, Germanic, and Slavic languages, making it recognizable to speakers of many European languages, but it has a simple grammar that avoids the complexities often found in natural languages, like irregular verbs or noun cases. Esperanto has a strong global community with speakers across continents, literature, and even native speakers who learn it from birth in multilingual families.

% Ido is a reform of Esperanto that was proposed in 1907 by a group of linguists and led by Louis Couturat, a French philosopher and mathematician. Its creators sought to address what they saw as imperfections in Esperanto, particularly issues related to word formation, gender neutrality, and consistency. Ido retains much of Esperanto’s vocabulary and basic structure but simplifies some aspects of grammar and spelling. For instance, Ido avoids the use of the accusative case and reforms some Esperanto words to make them more universally recognizable. Although Ido never gained the same level of popularity as Esperanto, it still has a dedicated group of speakers and enthusiasts.

% Interlingua was developed by the International Auxiliary Language Association (IALA), under the leadership of Alexander Gode, and officially launched in 1951. The idea behind Interlingua was to create a language that could be understood by speakers of Romance languages without requiring prior study. Interlingua’s vocabulary is drawn from a wide range of languages, primarily Latin, Italian, Spanish, Portuguese, and French, but also German and English. Its grammar is highly simplified, with no inflections for case or gender, making it accessible to a wide audience. Interlingua is particularly valued for its aesthetic qualities, resembling natural languages closely enough that people with knowledge of related languages can understand it almost intuitively.

% Lingua Franca Nova, or LFN, is a relatively recent constructed language created by linguist C. George Boeree in 1998. It is designed as an easy-to-learn, creole-inspired language with a Romance-language-based lexicon. LFN was conceived to serve as an international auxiliary language with simplified grammar rules and phonetics, based on the historical Mediterranean Lingua Franca, a pidgin that developed for trade in the Mediterranean basin during the medieval period. The grammar of LFN avoids complex conjugations, gender distinctions, and irregular verbs. While still a niche language, Lingua Franca Nova has gained a modest following, especially in online communities, due to its simplicity and practicality.

% Kotava, designed by Staren Fetcey in 1978, is a unique attempt at creating a culturally neutral language, free from any biases or influences of existing national languages. Kotava’s main philosophy is linguistic egalitarianism, meaning that it does not derive its vocabulary or structure from any particular linguistic family, aiming to create a truly international language. Its grammar and vocabulary are entirely constructed, and it follows a logical, but not overly simplified, structure. Kotava has a fully developed lexicon for everyday use, and its creator envisioned it being used as a tool for global communication in any setting, from casual conversation to academic discourse. While Kotava has not achieved widespread usage, it has a dedicated community of supporters who appreciate its ambitious goals and neutrality.

% Volapük, one of the earliest constructed languages, was created by Johann Martin Schleyer, a German Catholic priest, in 1879–1880. Schleyer believed he had been divinely inspired to create a universal language that could unite people across national boundaries. Volapük is notable for its highly agglutinative structure, where complex meanings are built by stringing together prefixes, suffixes, and roots. The vocabulary of Volapük is derived primarily from English, German, and Romance languages, but the words are often highly distorted to fit Schleyer’s phonetic system, making it difficult to recognize their origins. Volapük enjoyed a brief period of popularity in the late 19th century, with clubs and societies forming around the world, but its complexity led to a rapid decline in favor of simpler constructed languages like Esperanto.
...
% Briefly introduce and explain Keras, PyTorch, NumPy, Pandas, Matplotlib, scikit-learn libraries
