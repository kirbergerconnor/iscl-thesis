...
In this section, I explain in greater detail the corpora data used for this research, as well as the approaches and steps taken to arrive at my results. 
...
\label{ssec:preliminarycalculations}
...
The Shannon entropy was calculated for the character and word distributions in each of the corpora, given by the following formula: \[H = -\sum_{i=1}^{n}p_{i}\log_{2}p_{i}\]
...
\label{ssec:morphologicalanalysis}
